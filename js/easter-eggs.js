...
(function () {
    ...
    // Feature: AZERTY Prohibition
    function triggerAzertyProhibition() {
        showToast("😉 C'est fini le cauchemar, vous êtes sur QWERTY Français maintenant !", "easter-egg-toast--center");
    }
    ...
    document.addEventListener('keydown', (e) => {
        ...
        // Check AZERTY
        if (keyBuffer.slice(-6).join('') === 'azerty') {
            triggerAzertyProhibition();
            keyBuffer = []; // Reset
        }
